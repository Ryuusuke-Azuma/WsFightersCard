...
- **タブの切り替え**: 
  ...
  - **データの連動更新**: 「Decks」タブでデッキ（詳細データ）が更新（追加・編集・削除）された際、その変更は「Fighters」タブのリスト内容にも自動的に即時反映される。
...
| 表示箇所 | 内容 | スタイル・挙動 |
| :--- | :--- | :--- |
| **ヘッダー** | **"Fighters"** という固定文字列 | ・アイテムの最上部に表示。<br>・右端には「自分に設定」の星マークと、「詳細オプション」ボタンを配置。 |
...
| 表示箇所 | 内容 | スタイル・挙動 |
| :--- | :--- | :--- |
| **ヘッダー** | **"Decks"** という固定文字列 | ・アイテムの最上部に表示。<br>・右端には詳細オプションボタンを配置。 |
